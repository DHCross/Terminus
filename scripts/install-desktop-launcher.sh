...
echo "  $LAUNCHER_PATH"
echo ""
echo "Double-click it to start Terminus and open https://localhost:8073 on this Mac."
echo "For phones or other devices on the same Wi-Fi, use the LAN URL printed by the launcher."
