...
// =============================================================================
// INLINE PROMPT (replaces window.prompt which is blocked in Electron)
// =============================================================================

/**
 * Shows a lightweight inline modal prompting the user for text input.
...
export function showPrompt(message, defaultValue = '') {
    return new Promise(resolve => {
        ...
        input.style.cssText = [
            'padding:8px 10px', 'border-radius:var(--radius-sm,4px)',
            'border:1px solid var(--border,#444)',
            'background:var(--bg-tertiary,#313244)',
            'color:var(--text,#cdd6f4)', 'font-size:14px', 'width:100%',
        ...
        cancelBtn.style.cssText = [
            'padding:6px 14px', 'border-radius:var(--radius-sm,4px)',
            'border:1px solid var(--border,#444)',
            'background:var(--bg-tertiary,#313244)',
            'color:var(--text-muted,#a6adc8)', 'cursor:pointer', 'font-size:13px',
        ].join(';');
        ...
        okBtn.style.cssText = [
            'padding:6px 14px', 'border-radius:var(--radius-sm,4px)',
            'border:1px solid var(--trim-border,var(--border,#444))',
            'background:var(--trim,#0f766e)',
