...
const DANGER_PLUGINS = {
    ...
    toolmaker: {
        ...
        warnings: [
            ...
            'Custom tools run inside the Terminus process with full access',
    ...
    attachListeners(ctx, el) {
            ...
            unsignedToggle.addEventListener('change', async e => {
                ...
                if (enabling) {
                    const confirmed = await showDangerConfirm({
                        ...
                        warnings: [
                            'Unsigned plugins have not been verified by Terminus',
                        ...
                        stage2Warnings: [
                            ...
                            'Terminus cannot guarantee the safety of unsigned code',
                        ],
                    });
                    if (!confirmed) {
        ...
        el.addEventListener('change', async e => {
            ...
            if (dangerConfig && e.target.checked) {
                const ackKey = `terminus_danger_ack_${name}`;
