        ...
        <div class="sched-editor">
            ...
            <div class="sched-editor-body">
                <p class="sched-editor-blurb">${isHeartbeat
                    ? 'Heartbeats wake Terminus up on a rhythm to check on things. She remembers what she found last time.'
                    : 'Tasks run at a scheduled time — an alarm that triggers Terminus to do something specific.'}</p>
                ...
                <div class="sched-field">
                    <label>${isHeartbeat ? 'What should Terminus check?' : 'What should Terminus do?'} <span class="help-tip" data-tip="What the AI receives when this fires. Be specific — the AI only knows what you tell it here.">?</span></label>
