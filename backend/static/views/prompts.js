...
function createPrompt() {
    ...
    async function create(type) {
        ...
        const data = type === 'monolith'
            ...
            : { type: 'assembled', components: { character: 'terminus', location: 'default', goals: 'default', relationship: 'default', format: 'default', scenario: 'default', extras: [], emotions: [] }, privacy_required: false };
        try {
