...
BROWSER_CAPABILITIES_TEXT = (
    ...
    "\nAutonomous Background Scheduler & Watchdogs (Pillar 6):"
    "\n- schedule_task(name, instruction, interval_minutes, cron_hour): Schedule autonomous background recurring tasks or job watchers (e.g. checking job boards, site monitors, daily briefings). Terminus sends macOS banner alerts when results are found."
    "\n- schedule_list_tasks(): Lists all active scheduled tasks, intervals, and heartbeats."
    "\n- schedule_cancel_task(task_id): Cancels a scheduled task."
