...
| Azure OpenAI v1 API Lifecycle | [learn.microsoft.com](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/api-version-lifecycle) | Documentation for the v1 API that eliminates api-version parameters and provides ongoing access to latest features with stable endpoints. |
